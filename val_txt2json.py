# -*- coding: utf-8 -*-
# @Time    : 2022-06-25 18:44
# @Author  : Zhikang Niu
# @FileName: val_txt2json.py
# @Software: PyCharm
"""
img_path = str
label:{
...
with open('filelist/places365_val.txt') as f:
    lines = f.readlines()
    for line in lines:
        line.strip()
...
final_dict["info"] = "Place365_val"
final_dict["image_dict"] = data_list

#INFO:写入json文件
with open('filelist/annotation_json/val.json','w') as f:
